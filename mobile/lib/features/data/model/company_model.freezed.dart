...
class _$CompanyModelImpl implements _CompanyModel {
  ...
  @override
  String toString() {
    return 'CompanyModel(id: $id, name: $name, profile: $profile, cover: $cover, description: $description, problem: $problem, verified: $verified)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, profile, cover, description, problem, verified);
...
abstract class _CompanyModel implements CompanyModel {
  factory _CompanyModel(
      ...
      required final bool verified}) = _$CompanyModelImpl;
